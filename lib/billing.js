...
export const PLAN_DEFS = [
  ...
  },
  {
    ...
    name: "STARTER",
    channelLimit: 3,
    ideaLimitMonthly: 100,
    executionLimitMonthly: 20,
    workspaceLimit: 1,
    priorityProcessing: false,
  },
  {
...
export function getBillingStatus({ workspaceId, userId }) {
  ...
  return {
    ...
    gateways: {
      ...
      mercado_pago: { configured: !!process.env.MERCADO_PAGO_ACCESS_TOKEN, webhookConfigured: !!process.env.MERCADO_PAGO_WEBHOOK_SECRET },
      pix: { configured: !!(process.env.PIX_KEY || process.env.MERCADO_PAGO_ACCESS_TOKEN), webhookConfigured: !!(process.env.PIX_WEBHOOK_SECRET || process.env.MERCADO_PAGO_WEBHOOK_SECRET) },
    },
  };
}
